...
<body>
	<div class="recherche">
		...
		<div id="menu">
			...
			<div class="example">
				<a
					href="<c:url value="/Servlet_selection"><c:param name="numCat" value="1"/></c:url>">
        <img
					src="images\inf.jpeg" alt="tile3" width="200" height="320px"
					alt="house" />
				<div class="fadedbox">
			...
			<div class="example">
				<a
					href="<c:url value="/Servlet_selection"><c:param name="numCat" value="4"/></c:url>"><img
					src="images\sport.jpeg" alt="tile3" width="200" height="320px"
					alt="house" /></a>
				<div class="fadedbox">
